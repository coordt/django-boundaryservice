...
from boundaryservice.settings import SHAPEFILES_DIR, GEOMETRY_COLUMN
...
class Command(BaseCommand):
    ...
    def get_version(self):
        from boundaryservice import get_version
        return get_version()
    ...
    def polygon_to_multipolygon(self, geom):
        """
        Convert polygons to multipolygons so all features are homogenous in 
        the database.
        """
